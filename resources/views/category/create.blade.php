                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Fill out the form below to add a new category.</p>
                        </div>
                        ...
                        <form action="{{ route('category.store') }}" method="POST" class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" id="slug" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                <p class="mt-1 text-xs text-gray-500">NB: Slug adalah nama kategori dengan huruf kecil dan dipisahkan tanda hubung, contoh: "kategori-baru".</p>
                                @error('slug')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
